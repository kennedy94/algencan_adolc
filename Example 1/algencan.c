...
void myevalh(int n, double *x, int *hrow, int *hcol, double *hval, int *hnnz, int lim, _Bool *lmem, int *flag);
...
int main() {
	...
	if ( x == NULL || l == NULL || u == NULL || lambda == NULL || equatn == NULL || linear == NULL ) {
